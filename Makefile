...
SRCS = activationKernels.cu main.cpp Matrix.cpp MatrixKernels.cu OutputLayer.cpp ReLULayer.cpp 
HEADERS = activationKernels.cuh config.h debug.h Layer.h Matrix.h MatrixKernels.cuh OutputLayer.h ReLULayer.h timer.cuh
